...
import Styles from '../../styles/ShortProduct.module.css'
const ShortProduct = () => {
    const products = [
        ...
        { img: cat3, category: 'Home Accessories', name: 'Hand Sanitizer', prevPrice: '140.99', curPrice: '90.99', bg: 'bg-sky-50' }
    ]
    return (
            ...
            <div className='grid grid-cols-3 gap-6'>
                {
                    products.map((p, i) => <div className={`text-center relative p-8 ${p.bg}`} key={i}>
                        ...
                        <h5>{p.category}</h5>
                        <h4 className='font-bold mt-3 mb-6'>{p.name}</h4>
