...
const BillAdd = ({ order, handleBlur }) => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-1 mt-5 gap-4'>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">First Name</span>
                    <input onBlur={handleBlur} className='input' type="text" name='FName' required />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Last Name</span>
                    <input onBlur={handleBlur} className='input' type="text" name='LName' required />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="">Company Name (optional)</span>
                    <input onBlur={handleBlur} className='input' name='company' type="text" />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Country / Region</span>
                    <select onBlur={handleBlur} className='input' name='country' required>
                ...
                <label className='flex flex-col gap-2'>
                    ...
                    <input onBlur={handleBlur} className='input' type="text" name='street1' placeholder='House Number and Street Name' required />

                    <input onBlur={handleBlur} className='input mt-2' type="text" name='street2' placeholder='Appartment, Suite, Unit, etc (optional)' />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Town / City</span>
                    <input onBlur={handleBlur} className='input' type="text" name='city' required />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Post Code</span>
                    <input onBlur={handleBlur} className='input' type="text" name='post_code' required />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Phone</span>
                    <input onBlur={handleBlur} className='input' type="text" name='phone' required />
                </label>
                <label className='flex flex-col gap-2'>
                    <span className="after:content-['*'] after:ml-1 after:text-red-500 cursor-pointer">Email Address</span>
                    <input onBlur={handleBlur} className='input' type="email" name='email' defaultValue={user?.email} required />
                </label>
