    ...
    try {
        if (req.method === "POST") {
            ...
            const data = {
                ...
                currency: 'BDT',
                tran_id,
                success_url: `https://${process.env.BASE_URL}/my_account/orders`,
                fail_url: `https://${process.env.BASE_URL}/api/v1/payment/fail`,
                cancel_url: `https://${process.env.BASE_URL}/api/v1/payment/cancel`,
